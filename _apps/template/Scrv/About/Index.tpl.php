...
<div class="contents">
	...
	<div class="about_content">
		...
		<p>● 好きなアルバム <img src="<?= h($base_path) ?>img/star_16.png">、好きな曲 <img src="<?= h($base_path) ?>img/check_16.png"> をチェック。</p>
	</div>

	<h3>あなたと同じアルバムを聴いた人、同じ曲が好きな人・・・</h3>
	<div class="about_content">
		<p>● Users &gt; ユーザ &gt; <img src="<?= h($base_path) ?>img/sync_16.png"> で探せます。</p>
	</div>
