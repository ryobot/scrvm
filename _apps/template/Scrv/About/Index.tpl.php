...
<div class="contents">
	...
	<div class="about_content">
		...
		<p>● アルバムページの Add Review でレビューを残す。</p><p class="about_content_sub">* レビューなし（単なる視聴記録）でも、適当なメモでも、ちゃんとした音楽レビューでもOK。</p><p class="about_content_sub">* あとから編集も可能。</p>
	...
	<div class="about_content">
		...
		<p>● Add Review で「post to twitter」が選択できるようになります。</p>
	</div>
	...
	<h3>改善案など・・・</h3>
	<div class="about_content">
		<p>「使いにくい・わかりにくい」「こういう機能がほしい」「不具合がある」などあれば、<a href="<?= h($base_path) ?>Posts">Posts</a> に書き込んでください。</p>
	</div>
